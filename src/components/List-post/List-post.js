...
function ListPost({ data }) {
  ...
  return (
    <li className="list__post">
      <section className="list__post__body">
        <div className="list__post__body__header">
          <Link
            className="list__post__body__header__title"
      ...
      <section className="list__post__info">
        <section className="list__post__info__text">
          <p className="list__post__info__text__user-name">{data.author.username}</p>
          <p className="list__post__info__text__created-at">{createDate}</p>
        </section>
        <img
          alt="icon"
          className="list__post__info__image"
